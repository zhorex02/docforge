...
<div><strong>{co.name}</strong>{f'<br/><span style="color:#6b7280;font-size:13px;">{co.address}</span>' if co.address else ''}{f'<br/><span style="color:#6b7280;font-size:13px;">{co.tax_id}</span>' if co.tax_id else ''}{f'<br/><span style="color:#6b7280;font-size:13px;">{co.email}</span>' if co.email else ''}{f'<br/><span style="color:#6b7280;font-size:13px;">{co.phone}</span>' if co.phone else ''}</div>
